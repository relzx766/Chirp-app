...
<div>
  ...
  <el-row>
    <el-col :span="4">
      <el-avatar :src="message.senderAvatar" fit="cover"/>
    </el-col>
    <el-col :span="20">
      <el-row>
      ...
      <el-row>
        ...
        <span  class="red-point" v-if="num>0">{{getNewMsgCount(num)}}</span>
      </el-row>
    </el-col>
  </el-row>
  </div>
...
<script>
import {getDate, getMessageDate, getNewMsgCount} from "../../util/tools";

export default {
  name: "MessageCard",
  methods: {getNewMsgCount, getMessageDate, getDate},
  props:{
    message:{},
    num:0
  }
