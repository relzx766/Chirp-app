...
<el-container>
  <el-main>
    <el-row>
      <el-col :span="8"  style="border-left:2px solid #EBEEF5;min-height: 100vh;border-right:2px solid #EBEEF5;">
        <el-row style="text-align: left;margin-bottom: 14px;">
          ...
          <el-tooltip content="新私信">
            <el-button icon="el-icon-chat-dot-square"
                       style="float:right;border: none;font-size: 20px;padding: 4px" circle></el-button>
          </el-tooltip>
        </el-row>
        <group-card/>
      </el-col>
