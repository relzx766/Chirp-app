    ...
    <el-col :span="21">
      <el-row>
        ...
        <el-col :span="2" :offset="4">
          <el-button v-if="item.id===$store.getters.getUser.id" round disabled>自己</el-button>
          <el-button v-else-if="item.relation===2" round style="background-color: #212121;color: white;font-weight:bold"
           @click="follow(item.id);item.relation=1">关注</el-button>
          <el-button v-else-if="item.relation===1" round type="primary" style="font-weight: bold"
          @click="unFollow(item.id);item.relation=2">已关</el-button>
        </el-col>
      </el-row>
