      ...
      <ul>
        <li
          ...
          <el-row style="margin-top: 40px;margin-bottom: 12px;">
            <profile-card :value="user" :is-self="$store.getters.getUser.id===this.user.id"/>
          </el-row>
          <el-row>
            <el-tabs  v-model="activeName" @tab-click="doChirperSelectClick" :stretch="true">
              <el-tab-pane name="chirper">
                <span style="font-size: 16px;font-weight: bold" slot="label">推文</span>
                <div id="chirper" style="padding: 6px">
                  <chirper-card v-for="item in chirpers" :chirper="item" shadow="hover" type="list"
                                style="border-bottom: 1px solid #E4E7ED;" />
                </div>
              </el-tab-pane>
              <el-tab-pane name="reply"><span style="font-size: 16px;font-weight: bold" slot="label">回复</span>
              </el-tab-pane>
              <el-tab-pane name="media"><span style="font-size: 16px;font-weight: bold" slot="label">媒体</span>
              </el-tab-pane>
              <el-tab-pane name="like"><span style="font-size: 16px;font-weight: bold" slot="label">喜欢</span>
              </el-tab-pane>
            </el-tabs>
          </el-row>
        </li>
